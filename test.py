...
# r = ms.RecognizeSpeech_FromFile(r'F:\SpeechRecognition\dataset\data_thchs30\data\D4_787.WAV')
r = ms.RecognizeSpeech_FromFile(r'F:\Users\QQT\Documents\Python Projects\Speech_Recognition_TF\MySR\data\Mydata\test\My(5).wav')
